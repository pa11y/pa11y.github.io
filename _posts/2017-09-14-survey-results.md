...
In Pa11y 5, we'll be moving from PhantomJS to headless Chrome. The [Pa11y 5.x beta is already available](https://github.com/pa11y/pa11y/tree/5.x) for you to try out now. 
